...
2. **For Development Mode:**
   ...
   - **In the Security tab, create a user with Full Admin privileges** (this account will be used as `DB_USER` in your `.env.development`, allowing the application to connect to your local database).
